...
///
/// A InstancedRenderMatrix is an instanced render call optimized to draw
...
pub struct InstancedRenderMatrix {
  matrix: [[f32; 4]; 4],
}

impl InstancedRenderMatrix {
